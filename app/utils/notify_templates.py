...
def welcome_intro() -> str:
    ...
    return (
        ...
        "I keep you in the loop on Nigerian domestic flights:\n"
        "  • Live boarding, gate & delay updates from other passengers\n"
        "  • Fare-drop alerts when prices fall on your route\n\n"
        f"{EMOJI_AIRLINE} At the airport? Text your flight number to join "
        "its live channel:\n"
        "  TRACK P47123\n"
        "Then text what you see, e.g. 'boarding now gate 12'.\n\n"
        "Looking for prices? Try:\n"
